    ...
    render() {
      return (
          <div className="mdl-card mdl-cell mdl-cell--4-col mdl-cell--12-col-phone mdl-shadow--4dp">
            ...
            <div className="grower"></div>
            <div className="mdl-card__supporting-text">
                <Chip extraClasses="mdl-color--green-A400" typeOfChips={this.props.product.tpenspecial} chipText="en spécial"/>
                <Chip extraClasses="mdl-color--yellow-200" typeOfChips={this.props.product.tppastilledegout} chipText={this.props.product.tppastilledegout}/>
                <Chip extraClasses="mdl-color--purple-200" typeOfChips={this.props.product.tpcepagesplitgroup} chipText={this.props.product.tpcepagenomsplitgroup.split(';').join(" | ")}/>
                <Chip extraClasses="mdl-color--blue-200" typeOfChips={this.props.product.tpparticularite} chipText={this.props.product.tpparticularite}/>
            </div>
            <div className="mdl-card__actions mdl-card--border">
              <a id={`link-${this.props.product.tpcodesaq}`} className="mdl-button mdl-button--colored mdl-js-button mdl-js-ripple-effect mdl-color-text--pink-600 product-link" target="_blank" href={this.props.product.sysclickableuri}>
                VOIR FICHE
              </a>
              <div className="mdl-layout-spacer"></div>
              <button id={`accords-btn-${this.props.product.tpcodesaq}`} onClick={this.showDialog.bind(this)} className="mdl-button mdl-button--icon mdl-button--colored" disabled={this.props.product.tpaccordsnommenu ? false : true}>
